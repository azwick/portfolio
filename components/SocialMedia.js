    ...
    return ( 
        <nav class={styles.bar}>
              <ul class={styles.list}>
                ...
                <li class={styles.item}>
                    <a class={styles.link} target="_blank" rel="noopener noreferrer" href="https://www.xing.com/profile/AnneDebora_Zimmermann/">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                  ...
                  <li class={styles.item}>
                    <a class={styles.link} target="_blank" rel="noopener noreferrer" href="https://github.com/azwick">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                  ...
                  <li class={styles.item}>
                    <a class={styles.link} target="_blank" rel="noopener noreferrer" href="https://twitter.com/Mrs_Zwickermann">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                  ...
                  <li class={styles.item}>
                    <a class={styles.link} target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/zwickermanns_on_tour/">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
